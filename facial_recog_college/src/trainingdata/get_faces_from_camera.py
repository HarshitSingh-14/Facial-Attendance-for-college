    ...
    def collectImagesFromCamera(self):
        ...
        while faces < max_faces:
            ...
            if len(bboxes) != 0:
                ...
                # if all features there
                if frames % 3 == 0:
                    # convert to face attributes
                    ...
                    print("Progress.. {} Image Captured".format(faces + 1))
                    faces += 1


            cv2.imshow("Face detecting window", frame)
